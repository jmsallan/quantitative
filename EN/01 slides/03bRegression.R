### R code from vignette source 'main-regression.Rnw'
### Encoding: UTF-8
...
par(mfrow=c(1,2))
par(pty="s")
plot(x, y1, pch=19, col="orange", xlab="x", ylab="y1", cex.lab=0.7, cex.axis=0.7, main=c("heteroskedastic"))
abline(mod.y1)
par(pty="s")
plot(x, y2, pch=19, col="orange", xlab="x", ylab="y2", cex.lab=0.7, cex.axis=0.7, main=c("homoskedastic"))
abline(mod.y2)
